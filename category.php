...
<main class="container category">
    <div class="page-heading">
        <h1 class="category__title"><?php single_cat_title(); ?><?php if(isset($wp_query->query['paged']) && $wp_query->query['paged'] > 1) { ?><span>&nbsp;-&nbsp;Strona <?php echo $wp_query->query['paged'] ?></span><?php }?></h1>
